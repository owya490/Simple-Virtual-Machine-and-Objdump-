...
void run_cpu(vm_cpu* c) {
    ...
    //printf("LOLOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO");
}
...
int main(int argc, char** argv) {
    ...
    //unsigned char arr[9] = {'|', '0', 'm', 'x', '0', 'v', '1', '3', 'R'};
    //vm_cpu* c = new_cpu(arr, 9);
    find_function(c, 0);
    //printf("FIRST PC: %d\n", c->pc);
