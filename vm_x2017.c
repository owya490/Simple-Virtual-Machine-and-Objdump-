...
*    Owen Yang
*    500550430
*    DESCRIPTION: FILE FOR vm.c
*************************************************************************************/
#include "vm_header.h"
#include "objdump.c"

// The main function of the Virtual Machine
int main(int argc, char** argv) {
    ...
    // Initialising start up Variables and settings - finding function 0
    find_function(c, 0);
    c->ip = 0;
    c->ram[0] = 0;
    c->sp = 0;
...
// Assigning Types and Values for Operand Command 1
...
// Assigning Types and Values for Operand Command 2
...
//Finding the Function in Instruction Array
...
//  Run CPU looping through Fetch and Execute
